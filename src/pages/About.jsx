...
const About = () => {
  return (
    <section className='about pb-[90px] container ' id="about">
      <div className='container mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-2  gap-10'>
          <div>
            <h1 className='font-Oswald mb-10  text-headColor text-4xl tracking-[10px] uppercase'>About <span className='text-secondary tracking-[10px]'> bauen</span></h1>
          ...
          <div className='relative mb-20'>
            ...
            <button className='absolute -bottom-7 right-6 lg:-bottom-6   text-[13px] lg:right-10 uppercase px-8 py-4 lg:px-12 lg:py-5 font-Oswald font-light tracking-[5px] bg-boxColor text-white'>
              canada office
            </button>
            </div>
        </div>
