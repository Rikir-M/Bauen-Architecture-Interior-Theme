...
import "./BlogCard.css";
import home1 from "../assets/images/bg1.jpg";
import home2 from "../assets/images/bg2.jpg";
...
const BlogCard = () => {
  ...
  return (
    <div className="select-none container mx-auto flex flex-col justify-center  min-h-screen">
