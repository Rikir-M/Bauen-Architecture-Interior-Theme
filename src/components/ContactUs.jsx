...
const ContactUs = () => {
  return (
    <div className="bg-primary">
       <div className="container mx-auto flex flex-col justify-center  min-h-screen pb-[90px]">
      <h2 className="text-4xl font-normal font-Oswald mb-8 text-start py-3 sm:py-0">
        <span className="text-white">C O N T A C T</span> &ensp;{" "}
        <span className="text-secondary">U S</span>
      </h2>
